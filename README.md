...
**OOP-school-library** is a simple program to record what books are in the library and who borrows them. The app allows you to: Add new students or teachers, Add new books and Save records of who borrowed a given book and when.
...
Install Ruby
Go to github and find the repository OOP-school-library
...
```sh
  cd my-folder
  git clone git@github.com:rosemutai/OOP-school-library.git
```
--->
...
```sh
  git@github.com:rosemutai/OOP-school-library.git
```
 -->
...
Feel free to check the [issues page](https://github.com/rosemutai/OOP-school-library/issues).
...
This project is [MIT](https://github.com/rosemutai/OOP-school-library/blob/main/LICENSE) licensed.
